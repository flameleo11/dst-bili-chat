...
// var my_roomid = 5183792; // other demo
var my_roomid = 4136343; // my live
var my_uid = 68988848;
const bili_prefix = "##bilichat##"
const cfg_dst_echo_prefix = "/"

const cfg_uid_me  = 68988848;
const cfg_roomid  = 4136343;

const cfg_cluster_ini = `/drive_d/game/dstserver/klei/${cluster_name}/cluster.ini`
const dst_folder     = "/drive_d/SteamLibrary/steamapps/common/Don't Starve Together/data/"
const chat_file_name = "my_chat_outside.txt"
const cfg_dst_bilichat_pipe = dst_folder + chat_file_name;
...
// todo test
var cfg_ds1_chat1 = "/drive_d/game/dstserver/klei/367833552/Cluster_4/Master/server_chat_log.txt"

const cfg_chat_interval = 1200;
const cfg_1_sec = 1000
var gg_timer_sec = null
//----------------------------------------------------------
// base
//----------------------------------------------------------
...
const dst_chat_log = spawn('tail', ['-f', cfg_master_chat_log]);
...
function toggleDSTChatLogInput() {
  dst_chat_log.stdout.on('data', function (buf) {
